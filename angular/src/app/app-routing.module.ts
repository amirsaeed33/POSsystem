...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'purchase-returns', data: { breadcrumb: 'Purchase Returns' }, loadChildren: () => import('./demo/components/purchase-returns/purchase-returns.module').then(m => m.PurchaseReturnsModule) },
