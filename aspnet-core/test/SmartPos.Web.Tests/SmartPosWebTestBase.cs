...
{
    public abstract class SmartPosWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartPosWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartPosWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartPosDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartPosDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartPosDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartPosDbContext, Task<T>> func)
        {
            T result;
