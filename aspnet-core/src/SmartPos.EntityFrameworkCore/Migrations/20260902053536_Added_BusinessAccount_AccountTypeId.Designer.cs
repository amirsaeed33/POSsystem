...
namespace SmartPos.Migrations
{
    ...
    [Migration("20260902053536_Added_BusinessAccount_AccountTypeId")]
    partial class Added_BusinessAccount_AccountTypeId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPos.HostCatalog.BranchSeedRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppBranchSeedRequests");
                });

            modelBuilder.Entity("SmartPos.HostCatalog.BranchSeedRequestItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BranchSeedRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchSeedRequestId", "HostItemId")
                        .IsUnique();

                    b.ToTable("AppBranchSeedRequestItems");
                });

            modelBuilder.Entity("SmartPos.HostCatalog.HostCatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Type", "CompanyTypeId", "IsActive");

                    b.HasIndex("Type", "CompanyTypeId", "Name")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("AppHostCatalogItems");
                });
            ...
            modelBuilder.Entity("SmartPos.Staffs.StaffPayroll", b =>
                {
                    ...
                    b.HasIndex("StaffId", "Year", "Month", "BranchId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("SmartPos.Accounts.BusinessAccount", b =>
                {
                    b.HasOne("SmartPos.Lookups.LookUp", "AccountTypeLookup")
                        .WithMany()
                        .HasForeignKey("AccountTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AccountTypeLookup");
                });
            ...
            modelBuilder.Entity("SmartPos.Authorization.Users.User", b =>
                {
                    b.HasOne("SmartPos.Branches.Branch", "Branch")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartPos.Categories.Category", b =>
                {
                    ...
                    b.HasOne("SmartPos.Units.Unit", "DefaultUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartPos.HostCatalog.BranchSeedRequest", b =>
                {
                    ...
                    b.HasOne("SmartPos.HostCatalog.HostCatalogItem", "CompanyType")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartPos.HostCatalog.BranchSeedRequestItem", b =>
                {
                    b.HasOne("SmartPos.HostCatalog.BranchSeedRequest", "BranchSeedRequest")
                        .WithMany("Items")
                        .HasForeignKey("BranchSeedRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartPos.HostCatalog.HostCatalogItem", "HostItem")
                        .WithMany()
                        .HasForeignKey("HostItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BranchSeedRequest");
            ...
            modelBuilder.Entity("SmartPos.Staffs.StaffAttendance", b =>
                {
                    ...
                    b.HasOne("SmartPos.Staffs.Staff", "Staff")
